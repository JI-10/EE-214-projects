...
-- Equation(s):
-- \dut_instance|add_instance|Y~0\ = (\dut_instance|add_instance|y_present.s4~regout\ & (\dut_instance|add_instance|Equal2~0\ & (!dut_input[6] & !dut_input(3))))
-- dut_input(6) = DFFEAS(\dut_instance|add_instance|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.rst~regout\ = DFFEAS((!\dut_instance|add_instance|Y~0\ & (!dut_input(1) & ((\dut_instance|add_instance|Equal0~0_combout\) # (\dut_instance|add_instance|y_present.rst~regout\)))), GLOBAL(dut_input(0)), VCC, , , , , , )
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|Y~0\,
	oe => VCC,
